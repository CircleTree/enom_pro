	...
	<div class="well">
		<div class="row">
			<div class="col-lg-6" id="bulkPricingImportWrap">
				<div class="enom-pro-icon enom-pro-icon-cancel-circle close-bulk-editor ep_tt"
				     title="Close Bulk Pricing editor" data-placement="bottom"></div>

				<h3 class="hidden-turbo">
			<span class="btn btn-primary btn-lg open-bulk-editor ep_pop" title="Turbo TLD Importer"
			      data-content="Get rid of all of the distractions, and focus on selling an ever-growing list of the new TLDs.">
				...
				<form class="bulkImport form-inline"
					...
					<div class="form-group col-xs-12">
						<h5 class="ep_pop" title="Minimum Markup" data-placement="auto top"
						    data-content="Enter the minimum acceptable markup. Use this to cover credit card processing fees, for example.">Minimum Markup</h5>
					...
					<div class="form-group col-xs-12">
						<h5 class="ep_pop" title="Preferred Markup" data-placement="auto top"
						    data-content="The Markup you'd like to make, while still being protected from under-selling.">Preferred Markup</h5>
						...
						<div class="input-group">
							...
							<select name="round" id="roundTo" class="form-control input-sm-2">
								<?php foreach ( $rounding_options as $value => $label ): ?>
									...
									<option
										value="<?php echo $value ?>"<?php echo $selected ?>><?php echo $label ?></option>
								<?php endforeach; ?>
							</select>
						</div>
						<div class="input-group checkbox">
							<label for="overWriteWHMCS" class="input-group-addon">
								<input type="checkbox" name="overwrite"
								       id="overWriteWHMCS" <?php echo enom_pro::get_addon_setting( 'overwrite_whmcs' ) == '1' ? 'checked="checked"' : '' ?>/>
					...
					<div class="btn-group pull-right">
						<button type="submit" class="btn btn-primary ep_pop"
						        data-content="Press ENTER in the form above for rapid previewing" title="Helpful Hint"
						        data-placement="auto top" data-container="body">Preview
							<span class="enom-pro-icon-refresh-alt"></span>
						</button>
						...
						<div class="btn-group">
							<button type="reset" class="btn btn-danger clear_all ep_pop"
							        data-content="Clears the pricing on this page" data-placement="top"
							        data-toggle="popover" data-container="#bulkLeftWrap">Clear
		...
		<span class="text-muted">
			...
			<a class="btn btn-sm btn-inverse"
			   href="<?php echo enom_pro::MODULE_LINK; ?>&action=clear_price_cache">
				Clear Cache
				<span class="enom-pro-icon-trash"></span>
			</a>
		</span>
			</div>
		</div>
