...
<div class="enom_pro_widget">
	<?php $class = $warning ? 'alert-danger' : 'alert-success'; ?>
		<div id="enom_balance_message" class="alert <?php echo $class ?>">
	...
	<?php if ( $license->is_update_available() ) : ?>
		<div class="alert alert-info text-center"><b>Update available!</b>
			<span class="text-muted">Version: <?php echo $license->get_latest_version() ?></span>
			<br />
