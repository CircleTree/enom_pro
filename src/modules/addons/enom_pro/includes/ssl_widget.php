...
<div class="enom_pro_widget alert <?php echo (count($expiring_certs) > 0 ? 'alert-danger' : 'alert-success') ?>">
	...
	<?php foreach ($expiring_certs as $cert) : ?>
		<tr>
			...
			<td style="text-align:center;">
				<a href="http://www.enom.com/secure/configure-ssl-certificate.aspx?certid=<?php echo $cert['CertID'] ?>" target="_blank" class="btn btn-default" >
...
<?php elseif (! isset($_REQUEST['show_all']) && "" != ($hidden = enom_pro::get_addon_setting('ssl_hidden'))): ?>
	...
	<p><b>But there are <?php echo $count ?> hidden certificates</b><a href="#" class="show_hidden_ssl">Show All</a></p>
<?php else:  ?>
