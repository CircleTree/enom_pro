...
<ul class="menu">
    <li>
        <a class="btn btn-block btn-default" href="<?php echo enom_pro::MODULE_LINK; ?>">
...
<span class="header"><?php echo ENOM_PRO; ?> Meta</span>
        ...
        <a class="btn btn-default btn-xs btn-block" href="<?php echo enom_pro::MODULE_LINK?>&action=do_upgrade_check">
            Check for updates <span class="enom-pro-icon enom-pro-icon-update"></span>
        </a>
			</div>
			<div class="col-xs-12">
			<a
			...
			<div class="col-xs-12">
					<a href="<?php echo enom_pro::INSTALL_URL; ?>" target="_blank" class="btn btn-default btn-xs btn-block">Order Install Service</a>
			</div>
		</div>
	</div>
	<p>&nbsp;</p>
